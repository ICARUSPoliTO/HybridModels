...
class OptimizationOutputPage:
    ...
    TAB_DEFINITIONS = {
        ...
        'Pressures & Flows': {
            'variables': ['pc_array', 'p_inj_array', 'mdot_array', 'mdot_ox_array', 'mdot_fuel_array'],
            'labels': {
                'pc_array': 'pc [bar]',
                'p_inj_array': 'p_inj [bar]',
    ...
    def _update_text_results(self):
        ...
        self.results_text.insert(tk.END, "Result Statistics:\n")
        self.results_text.insert(tk.END, "-" * 30 + "\n\n")
