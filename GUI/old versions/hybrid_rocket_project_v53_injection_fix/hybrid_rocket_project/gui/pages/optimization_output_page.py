    ...
    def _update_text_results(self):
        ...
        if 'Ivac_array' in self.results:
            ...
            if len(valid_indices) > 0:
                ...
                # Header
                self.results_text.insert(tk.END, 
                    f"{'#':>3} {'Ivac[s]':>10} {'Is[s]':>10} {'Dport/Dt':>10} {'Dinj/Dt':>10} {'Lc/Dt':>10} {'MR':>8} {'pc[bar]':>10}\n")
                self.results_text.insert(tk.END, "-" * 82 + "\n")
                ...
                for rank, flat_idx in enumerate(sorted_indices[:top_n], 1):
                    ...
                    self.results_text.insert(tk.END, 
                        f"{rank:>3} {ivac_val:>10.2f} {is_val:>10.2f} {dport_val:>10.2f} {dinj_val:>10.3f} {lc_val:>10.2f} {mr_val:>8.2f} {pc_val:>10.2f}\n")
